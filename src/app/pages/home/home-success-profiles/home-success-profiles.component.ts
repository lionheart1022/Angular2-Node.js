...
@Component({
  selector: 'app-home-success-profiles',
  templateUrl: './home-success-profiles.component.html',
  styleUrls: ['./home-success-profiles.component.scss']
})
export class HomeSuccessProfilesComponent implements OnInit {
