...
@Component({
  selector: 'digitalGoods',
  templateUrl: 'digitalGoods.component.html',
  styleUrls: ['digitalGoods.scss']
})
export class DigitalGoodsComponent implements OnInit {
  public title: string;
  ...
  ngOnInit(): void {
    ...
    const subcategories = this.allSubcatService.getSubCat('digitalGoods');
