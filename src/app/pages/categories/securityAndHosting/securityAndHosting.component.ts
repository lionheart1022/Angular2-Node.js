...
@Component({
  selector: 'app-securityAndHosting',
  templateUrl: 'securityAndHosting.component.html',
  styleUrls: ['securityAndHosting.scss']
})
export class SecurityAndHostingComponent {
  public title: string;
  items: any = [];
  constructor(
  ...
  ngOnInit(): void {
    const subcategories = this.allSubcatService.getSubCat('securityAndHosting');
