...
@Component({
  selector: 'home',
  templateUrl: 'ids_passports.component.html',
  styleUrls: ['ids_passports.scss']
})
export class IdsPassportsComponent implements OnInit {
  public title: string;
  items: any = [];
  constructor(
  ...
  ngOnInit(): void {
    const subcategories = this.allSubcatService.getSubCat('ids_passports');
