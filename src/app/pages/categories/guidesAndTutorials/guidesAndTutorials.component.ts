...
@Component({
  selector: 'app-guidesAndTutorials',
  templateUrl: 'guidesAndTutorials.component.html',
  styleUrls: ['guidesAndTutorials.scss']
})
export class GuidesAndTutorialsComponent {
  public title: string;
  items: any = [];
  constructor(
  ...
  ngOnInit(): void {
    const subcategories = this.allSubcatService.getSubCat('guidesAndTutorials');
