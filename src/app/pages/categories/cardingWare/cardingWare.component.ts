...
@Component({
  selector: 'app-cardingWare',
  templateUrl: 'cardingWare.component.html',
  styleUrls: ['cardingWare.scss']
})
export class CardingWareComponent implements OnInit {
  public title: string;
  items: any = [];
  constructor(
  ...
  ngOnInit(): void {
    ...
    const subcategories = this.allSubcatService.getSubCat('cardingWare');
